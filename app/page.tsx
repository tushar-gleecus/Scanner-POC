...
export default function Home() {
  return (
    <div className="flex flex-col items-center justify-center min-h-[80vh] space-y-8">
      <h1 className="text-4xl font-bold text-white">QR Form Manager</h1>
      ...
      <div className="flex space-x-6">
        ...
        >
          ...
          <h2 className="text-2xl font-semibold text-gray-800">Create Form</h2>
        ...
        >
          ...
          <h2 className="text-2xl font-semibold text-gray-800">Scan Code</h2>
          <p className="text-center text-gray-500 mt-2 px-4">
